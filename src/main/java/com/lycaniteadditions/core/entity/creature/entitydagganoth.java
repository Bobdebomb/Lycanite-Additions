...
public class entitydagganoth extends RideableCreatureEntity {

	// ==================================================
 	//                    Constructor
 	// ==================================================
    public entitydagganoth(World world) {
        super(world);
    ...
    public void specialAttack() {
        ...
        List<EntityLivingBase> possibleTargets = this.getEntityWorld().getEntitiesWithinAABB(EntityLivingBase.class, this.getEntityBoundingBox().grow(distance, distance, distance), possibleTarget -> {
			if(!possibleTarget.isEntityAlive()
					|| possibleTarget == entitydagganoth.this
					|| entitydagganoth.this.isRidingOrBeingRiddenBy(possibleTarget)
					|| entitydagganoth.this.isOnSameTeam(possibleTarget)
					|| !entitydagganoth.this.canAttackClass(possibleTarget.getClass())
					|| !entitydagganoth.this.canAttackEntity(possibleTarget))
				return false;
			return true;
		});
