package com.lycaniteadditions.core.info.altar;

import com.lycaniteadditions.core.entity.creature.entityparasight;
...
public class AltarInfoIrritated extends AltarInfo {

    // ==================================================
    //                    Constructor
    // ==================================================
    public AltarInfoIrritated(String name) {
        super(name);
    }
    ...
    public boolean fullCheck(Entity entity, World world, BlockPos pos) {
        ...
        if(world.getBlockState(pos.add(0, 3, 0)).getBlock() != bodyBlock)
            return false;
        if(world.getBlockState(pos.add(0, 4, 0)).getBlock() != bodyBlock)
            return false;
    ...
    public boolean activate(Entity entity, World world, BlockPos pos, int variant) {
        ...
        // Create Mini Boss:
        BaseCreatureEntity entityCreature = new entityparasight(world);
