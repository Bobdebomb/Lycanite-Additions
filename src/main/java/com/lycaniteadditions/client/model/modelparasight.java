...
public class modelparasight extends ModelObjOld {
    ...
    public modelparasight(float shadowSize) {
        // Load Model:
        this.initModel("parasight", LycanitesMobs.modInfo, "entity/parasight");
    ...
    public void animatePart(String partName, EntityLiving entity, float time, float distance, float loop, float lookY, float lookX, float scale) {
        ...
        float animationScaleZ = 0.03F;
        float animationScaleY = 0.02F;
        float animationScaleX = 0.01F;
        float animationDistanceZ = 0.02F;
        float animationDistanceY = 0.02F;
        float animationDistanceX = 0.01F;
