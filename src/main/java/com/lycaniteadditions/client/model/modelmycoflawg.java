...
public class modelmycoflawg extends ModelObjOld {

    // ==================================================
    //                    Constructors
    // ==================================================
    public modelmycoflawg() {
        this(1.0F);
    }

    public modelmycoflawg(float shadowSize) {
        // Load Model:
        this.initModel("mycoflawg", LycanitesMobs.modInfo, "entity/mycoflawg");
    ...
    public void animatePart(String partName, EntityLiving entity, float time, float distance, float loop, float lookY, float lookX, float scale) {
        ...
        if(entity != null && !entity.onGround && !entity.isInWater()) {
            if(partName.equals("legleftback") || partName.equals("legrightback"))
                rotX += 25;
            if(partName.equals("legrightfront") || partName.equals("legleftfront"))
                rotX -= 25;
        }
